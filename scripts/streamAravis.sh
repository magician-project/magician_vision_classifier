...
EXPOSURE_MICROSECONDS=4750 
FRAMES_PER_SECOND=15

sleep 1
ARV_DEBUG=stream:2 ./07-streamer --exposure $EXPOSURE_MICROSECONDS --size 2448 2048 --fps $FRAMES_PER_SECOND --maxFrames $FRAME_LIMIT --buffers 30 -o $1
